...
import { Socials } from "@/app/components/db";
      ...
      <div className="flex flex-wrap-reverse justify-around items-center pt-5">
        <div>
          <p className="text-gray-500 text-center">
            © 2023 Edem Agbetor. All rights reserved
          </p>
        </div>
        <div className="px-2">
              ...
              return (
                <motion.div key={id} whileHover={{ scale: 1.12 }}>
                  <Link
                    ...
                    className="flex h-10 w-10 flex-col items-center text-gray-500 hover:text-gray-200 justify-center rounded-full"
                  >
                    <span>{icon}</span>
                  </Link>
                </motion.div>
