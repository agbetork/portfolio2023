...
const Navlinks = [
  ...
  { id: 4, title: "UI", slug: "ui" },
  { id: 5, title: "Blender", slug: "blender" },
];
                ...
                `}
                  ...
                  <div className="">
                    <AnimatePresence mode="sync">
                      {open && (
                        <div className="fixed  right-0 top-0 z-30 min-h-screen w-full overflow-hidden navbg  font-black">
